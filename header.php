  ...
  <div class="container">
    ...
    <div class="header-actions">
      ...
      <button class="cart-toggle" type="button" id="cart-toggle-btn">
        ...
        <!-- Contador del carrito (JS lo actualiza) -->
...
<div id="cart-checkout-modal" class="booking-modal" style="display:none;">
  <div class="booking-modal-content">
    ...
    <div id="cart-modal-summary" class="cart-modal-summary"></div>

    <form id="cart-checkout-form" method="POST"
          action="<?php echo esc_url(admin_url('admin-post.php')); ?>">

      <input type="hidden" name="action" value="boskoa_cart_checkout">
      <input type="hidden" name="contact_nonce"
             value="<?php echo wp_create_nonce('boskoa_contact_form'); ?>">
      ...
      <div class="booking-form-group">
        ...
        <input type="text"
               id="cart_contact_name"
               name="contact_name"
               required
               placeholder="<?php pll_e('Your full name'); ?>">
      </div>

      <div class="booking-form-group">
        <label for="cart_contact_email"><?php pll_e('Email'); ?> *</label>
        <input type="email"
               id="cart_contact_email"
               name="contact_email"
               required
      ...
      <div class="booking-form-group">
        ...
        <textarea id="cart_contact_message"
      ...
      <button type="submit"
              class="booking-submit-btn cart-checkout-submit-btn">
