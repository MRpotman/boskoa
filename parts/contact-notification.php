    ...
    <div class="contact-notification <?php echo $_GET['contact'] === 'success' ? 'success' : 'error'; ?>" id="contactNotification">
        <div class="notification-content">
            <?php if ($_GET['contact'] === 'success'): ?>
                ...
                <div>
                    <strong><?php echo esc_html(pll__('Message sent!')); ?></strong>
                    <p><?php echo esc_html(pll__('Thank you for contacting us. We will get back to you soon.')); ?></p>
                </div>
            <?php else: ?>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <div>
                    <strong><?php echo esc_html(pll__('Error sending.')); ?></strong>
                    <p><?php echo esc_html(pll__('Please check the information and try again.')); ?></p>
                </div>
            <?php endif; ?>
