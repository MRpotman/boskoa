      ...
      <div class="slide <?php echo $slides->current_post === 0 ? 'active' : ''; ?>"
        ...
        <div class="hero-slide-title-container">
          ...
          <div class="hero-slide-social-container">
            <a href="https://www.facebook.com/share/189PciRXZS/" class="face">
              <i class="fa-brands fa-facebook"></i>
            </a>

            <a href="https://www.instagram.com/boskoa_travels?igsh=MWkzcDFhbmZwNDU4Mw==" class="insta">
              <i class="fa-brands fa-instagram"></i>
            </a>

            <a href="https://wa.me/message/ZGT5HWHZ3JY2D1" class="wasa">
        ...
        <div class="button-container">
          <a href="<?php echo esc_url($package_url); ?>" class="button-hero-slider">
            <?php pll_e('SEE PACKS →'); ?>
          </a>
        </div>
